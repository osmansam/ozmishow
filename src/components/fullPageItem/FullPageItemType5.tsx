...
const FullPageItemType5 = ({
  ...
  // Neumorphic styles
  const bgBase = "#e0e5ec";
  const shadowOuter = "9px 9px 16px rgb(163,177,198,0.6), -9px -9px 16px rgba(255,255,255, 0.5)";
  const shadowInner = "inset 6px 6px 10px 0 rgba(163,177,198, 0.7), inset -6px -6px 10px 0 rgba(255,255,255, 0.8)";
