    ...
    <div className="w-full" style={componentStyle}>
      ...
      {fullPageItemArray.map((fullPageItem, index) => {
        ...
        return (
          ...
          <div key={index} className="relative w-full min-h-[600px] flex items-end justify-start overflow-hidden border-b-4 border-white group">
            {/* Background Image */}
            {img && (
      ...
      {isAddNewItem && isAdmin && (
        <div className="bg-gray-100 py-16 px-4">
          <div className="max-w-3xl mx-auto bg-white p-8 shadow-xl">
            <h3 className="text-2xl font-bold text-gray-900 mb-8 text-center uppercase">New Hero Section</h3>
            <PictureContainer
